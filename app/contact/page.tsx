  ...
  return (
    <main className="min-h-screen bg-black text-slate-300 relative overflow-hidden flex items-center">
      ...
      <div className="max-w-4xl mx-auto px-6 py-20 relative z-10 w-full">
        ...
        {/* Header Section - Matches ProjectCard spacing & logic */}
        ...
        {/* Contact Links Grid - Using ProjectCard "Article" Styling */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          
          {/* Email Card */}
          <article className="group relative p-8 rounded-2xl transition-all duration-500 bg-slate-950/40 hover:bg-slate-900/60 overflow-hidden border border-slate-900">
            ...
            <div className="relative z-10 flex flex-col h-full">
               <span className="text-indigo-500/30 font-mono text-[10px] mb-4 group-hover:text-indigo-400 transition-colors uppercase tracking-widest">
                Direct_Mail
              </span>
              ...
              <div className="pt-4 border-t border-slate-900 group-hover:border-indigo-500/20 transition-colors">
                ...
                >
                  ...
                  <div className="h-8 w-8 rounded-full border border-slate-800 flex items-center justify-center group-hover:border-indigo-500/50 group-hover:bg-indigo-500/10 transition-all">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" className="transform -rotate-45 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
          ...
          <article className="group relative p-8 rounded-2xl transition-all duration-500 bg-slate-950/40 hover:bg-slate-900/60 overflow-hidden border border-slate-900">
            <div className="absolute -inset-px bg-gradient-to-br from-cyan-500/10 via-transparent to-indigo-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="pt-4 border-t border-slate-900 flex items-center justify-between">
                ...
                <span className="flex items-center text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-[0_0_10px_rgba(99,102,241,0.1)]">
                   Available
                </span>
              </div>
            </div>
      ...
      {/* Background Accents - Matching the subtle glow from your cards */}
